...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.videoPreview = QtWidgets.QWidget(self.plot_2)
        self.videoPreview.setGeometry(QtCore.QRect(10, 10, 501, 381))
        ...
        self.verticalLayout_10.addWidget(self.updateFrequencyPlotButton)

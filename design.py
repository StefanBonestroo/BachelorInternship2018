...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.videoPreviewFrame.setGeometry(QtCore.QRect(730, 10, 521, 401))
        ...
        self.verticalLayoutWidget_4 = QtWidgets.QWidget(self.videoPreviewFrame)
        self.verticalLayoutWidget_4.setGeometry(QtCore.QRect(9, 301, 501, 91))
        self.verticalLayoutWidget_4.setObjectName("verticalLayoutWidget_4")
        self.verticalLayout_17 = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_4)
        self.verticalLayout_17.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_17.setObjectName("verticalLayout_17")
        self.videoProgressBar = QtWidgets.QProgressBar(self.verticalLayoutWidget_4)
        self.videoProgressBar.setProperty("value", 0)
        self.videoProgressBar.setObjectName("videoProgressBar")
        self.verticalLayout_17.addWidget(self.videoProgressBar)
        self.horizontalLayout_11 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_11.setObjectName("horizontalLayout_11")
        self.playVideoButton = QtWidgets.QPushButton(self.verticalLayoutWidget_4)
        self.playVideoButton.setObjectName("playVideoButton")
        self.horizontalLayout_11.addWidget(self.playVideoButton)
        self.stopVideoButton = QtWidgets.QPushButton(self.verticalLayoutWidget_4)
        self.stopVideoButton.setObjectName("stopVideoButton")
        self.horizontalLayout_11.addWidget(self.stopVideoButton)
        self.unprocessedRadioButton = QtWidgets.QRadioButton(self.verticalLayoutWidget_4)
        self.unprocessedRadioButton.setChecked(True)
        self.unprocessedRadioButton.setObjectName("unprocessedRadioButton")
        self.horizontalLayout_11.addWidget(self.unprocessedRadioButton)
        self.processedRadioButton = QtWidgets.QRadioButton(self.verticalLayoutWidget_4)
        self.processedRadioButton.setObjectName("processedRadioButton")
        self.horizontalLayout_11.addWidget(self.processedRadioButton)
        self.verticalLayout_17.addLayout(self.horizontalLayout_11)
        self.videoPreviewLabel = QtWidgets.QLabel(self.videoPreviewFrame)
        self.videoPreviewLabel.setGeometry(QtCore.QRect(10, 10, 500, 281))
        self.videoPreviewLabel.setText("")
        self.videoPreviewLabel.setObjectName("videoPreviewLabel")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.playVideoButton.setText(_translate("MainWindow", "Play"))
        self.stopVideoButton.setText(_translate("MainWindow", "Stop"))
        self.unprocessedRadioButton.setText(_translate("MainWindow", "Unprocessed"))
        self.processedRadioButton.setText(_translate("MainWindow", "Processed"))

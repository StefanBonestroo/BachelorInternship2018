...
class Ui_Analysis(object):
    def setupUi(self, Analysis):
        ...
        self.verticalFrame_3 = QtWidgets.QFrame(self.layoutWidget)
        ...
        self.trackerLabel = QtWidgets.QLabel(self.verticalFrame_3)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.verticalLayout_9.addWidget(self.trackerLabel)
        self.horizontalLayout_11 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_11.setObjectName("horizontalLayout_11")
        self.yesTrackerRadioButton = QtWidgets.QRadioButton(self.verticalFrame_3)
        self.yesTrackerRadioButton.setObjectName("yesTrackerRadioButton")
        self.horizontalLayout_11.addWidget(self.yesTrackerRadioButton, 0, QtCore.Qt.AlignHCenter)
        self.noTrackerRadioButton = QtWidgets.QRadioButton(self.verticalFrame_3)
        self.noTrackerRadioButton.setChecked(True)
        self.noTrackerRadioButton.setObjectName("noTrackerRadioButton")
        self.horizontalLayout_11.addWidget(self.noTrackerRadioButton, 0, QtCore.Qt.AlignHCenter)

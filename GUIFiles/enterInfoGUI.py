...
class Ui_enterInfoWindow(object):
    def setupUi(self, enterInfoWindow):
        ...
        enterInfoWindow.resize(1111, 575)
        ...
        self.frame.setGeometry(QtCore.QRect(290, 10, 481, 511))
        ...
        self.verticalLayoutWidget_13.setGeometry(QtCore.QRect(780, 10, 301, 481))
        ...
        self.saveOutputButton.setGeometry(QtCore.QRect(780, 490, 301, 31))
        self.saveOutputButton.setObjectName("saveOutputButton")
        self.verticalLayoutWidget_3 = QtWidgets.QWidget(self.mainFrame)
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(10, 10, 271, 511))
    ...
    def retranslateUi(self, enterInfoWindow):
        ...
        self.label_6.setText(_translate("enterInfoWindow", "Raw data files"))
        self.setRawDataDirectoryButton.setText(_translate("enterInfoWindow", "Set Directory..."))
